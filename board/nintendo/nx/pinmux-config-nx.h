...
#ifndef _PINMUX_CONFIG_NX_H_
#define _PINMUX_CONFIG_NX_H_
...
static const struct tegra_gpio_config nx_gpio_inits[] = {
	/*        port, pin, init_val */
...
static const struct pmux_pingrp_config nx_pingrps[] = {
